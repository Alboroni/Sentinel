...
## Task 7: Create a playbook to respond to your Incidents
...
## Task 8: Use your new playbook to respond to a Incidents
...
## Task 9: (Optional) Review Additional Logic Apps in Azure Sentinel GitHub
